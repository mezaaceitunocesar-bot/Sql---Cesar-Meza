-- BD FUENTE: Pubs, BD DESTINO: Pubs_DW

PRINT 'INICIANDO PROCESO ETL PARA BD SEPARADA...';
GO
...
LEFT JOIN Pubs.dbo.titleauthor ta ON s.title_id = ta.title_id AND ta.au_ord = 1
LEFT JOIN Pubs.dbo.employee e ON t.pub_id = e.pub_id
...
PRINT 'PROCESO ETL COMPLETADO PARA BD SEPARADA';
GOy
FROM publishers;
GO